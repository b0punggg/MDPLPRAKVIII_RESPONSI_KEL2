            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="index.php?page=tampil_antri"><i class="fa fa-user" aria-hidden="true"></i>Data Pelanggan <span class="fa fa-chevron"></span></a>
                  </li>
                  <li><a href="index.php?page=tampil_transaksi"><i class="fa fa-exchange" aria-hidden="true"></i> Data Transaksi <span class="fa fa-chevron"></span></a>
                  </li>
                  <li><a href="index.php?page=tampil_laporan"><i class="fa fa-book" aria-hidden="true"></i> Laporan <span class="fa fa-chevron"></span></a>
                  </li>
                </ul>
              </div>
            </div>
